...
public class InputLiveStreamTimeController {
	...
	public String getLiveStreamsBySeqNo(@RequestParam("LiveStreamSeqNo") Integer LiveStreamSeqNo,Model model) {
...
//		List<InputLiveStreamTimeBean> InputLiveStreamTimeBeanList =  InputLiveStreamTimeService.getLiveStreamsByStreamName(streamName);
		...
		model.addAttribute("LiveStream", InputLiveStreamTimeService.getLiveStreamsBySeqNo(LiveStreamSeqNo));
