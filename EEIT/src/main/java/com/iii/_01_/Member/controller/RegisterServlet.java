...
//		}
//		
//		MemberBean mb = new MemberBean(account, password, nickname, firstname, lastname, gender, email, phone, address, photo, fileNamePath, birtdfhday, subscription, registerdate, lastlogin, ban)
//		try{
