	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-8 mb-4">
				<h3>讓我們知道您的意見~</h3>
				<form action="<c:url value="/customerreport/qa"/>"
					...
					<div class="control-group form-group">
						<div class="controls">
							<label>Account/帳號<span style="color: red">*</span></label> <input
								type="text" class="form-control" id="account" name="idd"
					...
					<div class="control-group form-group">
						<div class="controls">
							<label>Name/姓名與職稱<span style="color: red">*</span></label> <input
								type="text" class="form-control" id="nickname" name="name"
								value="${LoginOK.name}" required="required">
					...
					<div class="control-group form-group">
						<div class="controls">
							<label>Email/電子信箱<span style="color: red">*</span></label> <input
								type="email" class="form-control" id="email" name="mailbox"
								value="${LoginOK.email}">
					...
					<div class="control-group form-group">
						<div class="controls">
							<label>Title/主旨<span style="color: red">*</span></label> <input
								type="text" class="form-control" id="title" name="title" value="${param.title}">
					...
					<div class="control-group form-group">
						<div class="controls">
							...
							<textarea rows="4" cols="180" class="form-control" name="report"
								value="${param.report}" required="required">${param.report}</textarea>
					...
					<div class="control-group form-group">
						<div class="controls">
							<label>照片:</label> <input type="file" class="form-control"
